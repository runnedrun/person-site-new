...
const ProjectSchema = z.object({
  ...
  description: z
    .string()
    .describe("A brief description of the project, using markdown formatting"),
  technologyDemonstrated: z.string(),
  starterPromptForAiCopilot: z
    .string()
    .describe(
      "A detailed step by step guide for the AI to follow, using markdown formatting"
    ),
})
...
export const getProjectInformationFromTech = async ({
  information,
}: {
  ...
  try {
    ...
    console.log("ourout", response.output_parsed?.starterPromptForAiCopilot)
