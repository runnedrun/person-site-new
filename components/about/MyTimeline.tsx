        ...
        <div>
          <PlaceTimeline
            items={[
              ...
              { time: "September 2021-May 2024", place: "Geneva, Switzerland" },
              { time: "August 2024-Present", place: "Gothenburg, Sweden" },
            ]}
          />
          <div className="mt-4 text-sm text-muted-foreground">
            \*Notable mention for New York City and London, where I lived, on
            and off, for 1 month at a time, when I was figuring out where to go
            next.
          </div>
        </div>
      }
